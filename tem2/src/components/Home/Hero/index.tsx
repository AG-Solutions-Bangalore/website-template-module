...
const Hero = () => {
  ...
  return (
     <section className="relative pt-44 mb-14 bg-cover bg-center dark:bg-darkmode">
      <div className="w-full h-full absolute z-0 bg-heroBg rounded-b-none md:rounded-b-[119px] -left-0 md:-left-1/3 top-0 dark:bg-midnight_text"></div>
        ...
        <div className="grid grid-cols-12 items-center">
          <motion.div {...leftAnimation} className="lg:col-span-6 col-span-12">
            <h1 className="md:text-50 sm:text-40 text-28 text-midnight_text lg:text-start mb-9 lg:w-full w-3/4">
              ...
              <br />
              <span className="bg-border dark:bg-heroBg  md:text-50 text-36 rounded-lg lg:text-start text-primary max-w-max">
                online payment
              </span>
              <br />
              platform for your <br/> product.
            </h1>
