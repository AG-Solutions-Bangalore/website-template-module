      ...
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) flex justify-between lg:items-center xl:gap-16 lg:gap-8 px-4 py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            >
              <path d="M16.6111 15.855C17.591 15.1394 18.3151 14.1979 18.7723 13.1623C16.4824 13.4065 14.1342 12.4631 12.6795 10.4711C11.2248 8.47905 11.0409 5.95516 11.9705 3.84818C10.8449 3.96850 9.72768 4.37162 8.74781 5.08719C5.77590 7.25747 5.12529 11.4308 7.29558 14.4028C9.46586 17.3747 13.6392 18.0253 16.6111 15.855Z" />
            </svg>
          </button>
          ...
          {user ? (
            <div className="hidden lg:flex items-center gap-4">
               <div className="relative group">
                ...
                />
                <p className="absolute w-fit text-sm text-center z-10 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-200 bg-white dark:bg-white/5 text-midnight_text p-1 min-w-28 rounded-lg shadow-2xl top-full left-1/2 transform -translate-x-1/2 mt-3">
                  {user?.name || user?.email}
                </p>
              </div>
              <button
                onClick={handleSignOut}
                className="flex items-center bg-primary border border-primary hover:border-primary dark:text-white text-white px-4 py-2 gap-2 rounded-lg text-16 font-semibold hover:bg-transparent hover:text-primary dark:hover:text-primary"
              >
                Sign Out
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                to="/signup"
                className="flex items-center border border-primary dark:hover:border-primary bg-transparent dark:text-primary text-primary px-4 py-2 gap-2 rounded-lg text-16 font-semibold hover:bg-primary hover:text-white dark:hover:text-white"
              >
                Sign Up
                <Icon icon="solar:arrow-right-linear" width="24" height="24" />
              </Link>
            ...
            {user ? (
              <>
                <button
                  ...
                  className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700 w-full text-center"
                >
                  Sign Out
                </button>
                <div className="flex gap-2 items-center w-full border border-primary px-4 py-2 rounded-lg">
                  <img
                    src="/images/avatar_1.webp"
                    alt="User avatar"
                    width={25}
