              ...
              <form
                ...
                <div className='flex flex-col md:flex md:flex-row gap-6'>
                  ...
                  <div className='w-full'>
                    ...
                    <select
                      className='w-full bg-white mt-2 text-base px-4 rounded-full py-2.5 border transition-all duration-500 dark:text-white border-solid dark:border-white/20 focus:outline-0 dark:bg-black/40'
                      name='budget'
                      id='budget'
